...
<section class="sidebar">
	<ul class="sidebar-menu">
		...
		<?php $firstchild = $menu['menu_has_child'];?>
                ...
                <span><?php echo $menu["menu_title"]?></span><span class="label label-primary pull-right">4</span>
             </a>
						...
						<?php foreach($firstchild as $firstchildKey => $firstchildMenu): ?>
							<li>
								<a href="pages/layout/top-nav.html">
									...
									<?php echo $firstchildMenu["parent_menu_name"]?>
								</a>
								<?php if (!empty($firstchildMenu["submenu"])):?>
								<ul class="treeview-menu">
									<?php foreach($firstchildMenu["submenu"] as $secondchildKey => $secondchildMenu ): ?>
										<li>
											<a href="<?php echo $secondchildMenu["url"]?>"><i class="fa fa-circle-o"></i> TEST <?php echo $secondchildMenu["name"]?></a>
											<?php if (!empty($secondchildMenu["submenu"])):?>
											<ul class="treeview-menu">
												<?php foreach($secondchildMenu["submenu"] as $thirdchildKey => $thirdchildMenu ): ?>
													<li>
														<a href="<?php echo Yii::$app->urlManager->createUrl([$thirdchildMenu["url"]]);?>">
														<i class="fa fa-circle-o"></i> <?php echo $thirdchildMenu["name"] ?></a>
													</li>
												<?php endforeach; ?>
											</ul>
										<?php endif;?>
		...
		<?php endforeach; ?>
		  <li class="active">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li>
                  <a href="#"><i class="fa fa-circle-o"></i> Regional <i class="fa fa-angle-left pull-right"></i></a>
                  <ul class="treeview-menu">
