...
CREATE TABLE `mtcities` (
  ...
  CONSTRAINT `mtcities_ibfk_1` FOREIGN KEY (`city_country_id`) REFERENCES `mtcountries` (`country_id`) ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of mtcities
-- ----------------------------
INSERT INTO `mtcities` VALUES ('1', 'BANDUNG', '2015-11-11', '2015-11-11', 'ACTIVE', '2');
INSERT INTO `mtcities` VALUES ('2', 'JAKARTA', '2015-11-11', '2015-11-11', 'ACTIVE', '1');
INSERT INTO `mtcities` VALUES ('3', 'BOGOR', '2015-11-11', '2015-11-11', 'ACTIVE', '1');
INSERT INTO `mtcities` VALUES ('4', 'DEPOK', '2015-11-11', '2015-11-11', 'ACTIVE', '1');
INSERT INTO `mtcities` VALUES ('5', 'TANGERANG', '2015-11-11', '2015-11-11', 'ACTIVE', '1');
INSERT INTO `mtcities` VALUES ('6', 'BEKASI', '2015-11-11', '2015-11-11', 'ACTIVE', '1');
INSERT INTO `mtcities` VALUES ('7', 'KARAWANG', '2015-11-11', '2015-11-11', 'ACTIVE', '1');
INSERT INTO `mtcities` VALUES ('8', 'PURWAKARTA', '2015-11-11', '2015-11-11', 'ACTIVE', '1');
INSERT INTO `mtcities` VALUES ('9', 'CIKARANG', '2015-11-11', '2015-11-11', 'ACTIVE', '1');
INSERT INTO `mtcities` VALUES ('10', 'JAKARTA PUSAT', '2015-11-11', '2015-11-11', 'ACTIVE', '1');
INSERT INTO `mtcities` VALUES ('11', 'JAKARTA SELATAN', '2015-11-11', '2015-11-11', 'ACTIVE', '1');
INSERT INTO `mtcities` VALUES ('12', 'JAKARTA BARAT', '2015-11-11', '2015-11-11', 'ACTIVE', '1');
INSERT INTO `mtcities` VALUES ('13', 'JAKARTA UTARA', '2015-11-11', '2015-11-11', 'ACTIVE', '1');
INSERT INTO `mtcities` VALUES ('14', 'JAKARTA TIMUR', '2015-11-11', '2015-11-11', 'ACTIVE', '1');
...
-- ----------------------------
INSERT INTO `mtcountries` VALUES ('1', 'INDONESIA', '2015-11-11', '2015-11-19', 'INACTIVE');
INSERT INTO `mtcountries` VALUES ('2', 'MALAYSIA', '2015-11-12', '2015-11-19', 'ACTIVE');
INSERT INTO `mtcountries` VALUES ('3', 'SINGAPORE', '2015-11-12', '2015-11-12', 'ACTIVE');
INSERT INTO `mtcountries` VALUES ('4', 'JAPAN', '2015-11-12', '2015-11-12', 'ACTIVE');
INSERT INTO `mtcountries` VALUES ('5', 'DENMARK', '2015-11-13', '2015-11-13', 'ACTIVE');
INSERT INTO `mtcountries` VALUES ('6', 'TEST', '2015-11-13', '2015-11-13', 'ACTIVE');
INSERT INTO `mtcountries` VALUES ('7', 'TEST lagi', '2015-11-13', '2015-11-13', 'ACTIVE');
INSERT INTO `mtcountries` VALUES ('8', 'LAGI', '2015-11-13', '2015-11-13', 'ACTIVE');
INSERT INTO `mtcountries` VALUES ('9', 'LAGI LAH', '2015-11-13', '2015-11-13', 'ACTIVE');
INSERT INTO `mtcountries` VALUES ('10', 'TESTTTTT', '2015-11-17', '2015-11-17', 'ACTIVE');
INSERT INTO `mtcountries` VALUES ('11', 'TESTSSSSS', '2015-11-17', '2015-11-17', 'ACTIVE');
INSERT INTO `mtcountries` VALUES ('12', 'SIMALAKAMA', '2015-11-19', '2015-11-19', 'ACTIVE');
